...
def baricentric_energy_derivative(r, v, mu, frame='rotating'):
...
if False:
    ...
    np.savetxt(f"{trajectory_type}_initial_conditions_CR3BP.txt", data, header="x0 y0 z0 v0x v0y v0z Cj E_SOI h_min_periluneo h_perigeo")
